...
//create a pre defined user and password since we do not have database
$acc_username = "ThreenaRecto23";
$acc_password = "threenaganda";
$acc_fullname = "Threena R. Recto";
...
if (isset($_REQUEST['login_button']) ===true) { //start of login button
	//get the user name and password from the form and comapre to the predefined username and password
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			if(isset($_REQUEST['notexist'])===true){
		      				...
		      				echo "<div class= 'alert alert-warning' role='alert'> You are still Logged in. 
		      				Please <a href='account.php'> click here </a> to proceed. </div>";
		      			}
